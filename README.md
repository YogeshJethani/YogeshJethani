...
I'm actively expanding my skill set through **CodeSignal** with focused learning in:

- **GenAI Development** → Building next-generation AI applications
- **RAG Systems** → Implementing retrieval-augmented generation pipelines
- **Advanced Python** → Deepening expertise in Python for AI/ML
- **C++ Optimization** → Performance-critical algorithm implementation
